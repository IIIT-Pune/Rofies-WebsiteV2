...
export async function createUserAuthSession(userId) {
  const session = await lucia.createSession(userId, { role: "user" });
...
export async function createAdminAuthSession(userId) {

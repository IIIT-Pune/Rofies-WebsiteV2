...
export default function Signup() {
  return (
    <section>
      <div className="flex flex-row items-center justify-center px-6 md:h-[75vh] lg:py-0">
        <div className="w-full bg-white bg-opacity-45  rounded-xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
